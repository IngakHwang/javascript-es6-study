...
const popArrayItems = popArray.pop();
console.log(`after pop : ${popArray}`);
console.log(`removeItems : ${popArrayItems}\n`)
...
const shiftArrayItems = shiftArray.shift();
console.log(`after shift : ${shiftArray}`);
console.log(`removeItems : ${shiftArrayItems}\n`)
...
//제거한 요소가 배열로 반환
console.log(`splice 후 제거한 요소들 : ${spliceResultArray}`);        
//원본 배열 변경
...
// start : 복사를 시작할 인덱스
// end : 복사를 종료할 인덱스, 생략시 start 부터 모든 요소 복사 (option)
