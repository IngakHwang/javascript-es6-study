...
const pushArrayLength = pushArray.push('push item');
console.log(`after push : ${pushArray}`);
console.log(`pushArrayLength : ${pushArrayLength}\n`);
...
const unshiftArrayLength = unshiftArray.unshift('unshift item');
console.log(`after unshift : ${unshiftArray}`);
console.log(`unshiftArrayLength : ${unshiftArrayLength}\n`)
