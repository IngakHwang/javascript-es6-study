...
console.log(beforeEveryArray.every(isBelowThreshold));

console.log("every Test : " + [5,10,15].every(item => item>3));
console.log("every Test : " +[5,10,15].every(item => item<0));
console.log("every Test : " +[].every(item => item>3));       // 빈 배열은 언제 true